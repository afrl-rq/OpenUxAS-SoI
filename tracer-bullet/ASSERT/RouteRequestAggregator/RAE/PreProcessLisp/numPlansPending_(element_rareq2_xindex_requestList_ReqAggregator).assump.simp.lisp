...
(DEFFCONST |*translator generated name for rareq2_xindex-VALS*|
...
(DEFDATA |translator generated name for previous numPlansPending of var22|
         (RANGE INTEGER
          (*SRL-DATA-MINIMUM* <= _ <= *SRL-DATA-MAXIMUM*)))
(DEFFCONST
 |*translator generated name for previous numPlansPending of var22-VALS*|
 (QUOTE-ALL (GEN-INT-RANGE *SRL-DATA-MINIMUM* *SRL-DATA-MAXIMUM*)))
...
(DEFDATA |translator generated name for numPlansPending of (element rareq2_xindex of requestList of ReqAggregator)|
         (RANGE INTEGER
          (*SRL-DATA-MINIMUM* <= _ <= *SRL-DATA-MAXIMUM*)))
(DEFFCONST
 |*translator generated name for numPlansPending of (element rareq2_xindex of requestList of ReqAggregator)-VALS*|
 (QUOTE-ALL (GEN-INT-RANGE *SRL-DATA-MINIMUM* *SRL-DATA-MAXIMUM*)))
