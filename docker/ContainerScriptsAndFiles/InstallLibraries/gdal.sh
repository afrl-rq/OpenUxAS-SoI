...
LIBRARY_NAME="gdal"
LIBRARY_FOLDER_NAME="gdal"
SOURCE_ARCHIVE_FILE="gdal210.zip"
SOURCE_ARCHIVE_ADDRESS="http://download.osgeo.org/gdal/2.1.0/"
SOURCE_FOLDER_NAME="gdal-2.1.0"
...
echo "Install data..."
$_SUDO geographiclib-get-geoids best
