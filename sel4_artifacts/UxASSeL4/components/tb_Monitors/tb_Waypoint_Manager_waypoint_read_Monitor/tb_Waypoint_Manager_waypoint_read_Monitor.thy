 ...
 *    must be uncommented.
 *)
theory tb_Waypoint_Manager_waypoint_read_Monitor
imports AUTOCORRES_HOME
begin


install_C_file "src/tb_Waypoint_Manager_waypoint_read_Monitor.c"
autocorres[ts_rules = nondet, heap_abs_syntax] "src/tb_Waypoint_Manager_waypoint_read_Monitor.c"

context tb_Waypoint_Manager_waypoint_read_Monitor begin
