...
apply (unfold mon_dequeue'_def)
  apply wp
  apply (auto simp: fun_upd_def is_queue_def the_queue_def tb_Virtual_Machine_in_waypoint_Monitor.update_tb_MissionSoftware__mission_command_impl_container_def
