...
TEST(PatternSearchTask_test, CorrectNumberMessages)
{
    //**************************************************************************
    ...
    testPath = "../tests/Test_Services/00_ExampleTests/99_Test_Tasks/Test_PatternSearchTask/";
    configFileName = "cfg_PatternSearchTask.xml";
    ...
    */
    ...
    EXPECT_EQ( 1, CountMessagesInLogDb(savedMessagesPath, std::string("uxas.messages.route.RoutePlanRequest")));
