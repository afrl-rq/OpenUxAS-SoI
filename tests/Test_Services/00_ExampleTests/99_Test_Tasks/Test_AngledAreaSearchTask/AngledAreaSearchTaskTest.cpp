...
TEST(AngledAreaSearchTaskTest, CorrectNumberMessages)
{
    //**************************************************************************
    ...
    testPath = "../tests/Test_Services/00_ExampleTests/99_Test_Tasks/Test_AngledAreaSearchTask/";
    configFileName = "cfg_AngledAreaSearchTask.xml";
    ...
    */
    ...
    EXPECT_EQ(5, CountMessagesInLogDb(savedMessagesPath, std::string("uxas.messages.route.RoutePlanRequest")));
