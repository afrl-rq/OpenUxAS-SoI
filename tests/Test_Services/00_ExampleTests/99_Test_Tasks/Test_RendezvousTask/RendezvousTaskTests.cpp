...
TEST(RendezvousTask_test, CorrectNumberMessages)
{
    //**************************************************************************
    ...
    testPath = "../tests/Test_Services/00_ExampleTests/99_Test_Tasks/Test_RendezvousTask/";
    configFileName = "cfg_RendezvousTask.xml";
    ...
    */
    ...
    EXPECT_EQ( 1, CountMessagesInLogDb(savedMessagesPath, std::string("uxas.messages.task.RendezvousTask")));
