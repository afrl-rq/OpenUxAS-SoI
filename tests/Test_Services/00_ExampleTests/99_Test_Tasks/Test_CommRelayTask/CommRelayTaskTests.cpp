...
TEST(CommRelayTask_Test01, CorrectNumberMessages)
{
    //**************************************************************************
    ...
    testPath = "../tests/Test_Services/00_ExampleTests/99_Test_Tasks/Test_CommRelayTask/";
    configFileName = "cfg_CommRelayTask.xml";
    ...
    */
    ...
    EXPECT_EQ( 2, CountMessagesInLogDb(savedMessagesPath, std::string("afrl.cmasi.MissionCommand")));
    EXPECT_EQ( 1, CountMessagesInLogDb(savedMessagesPath, std::string("afrl.cmasi.PointSearchTask")));
    EXPECT_EQ( 1, CountMessagesInLogDb(savedMessagesPath, std::string("afrl.impact.CommRelayTask")));
    EXPECT_EQ( 1, CountMessagesInLogDb(savedMessagesPath, std::string("afrl.impact.RadioTowerConfiguration")));
    EXPECT_EQ( 1, CountMessagesInLogDb(savedMessagesPath, std::string("afrl.impact.RadioTowerState")));
    EXPECT_EQ( 2, CountMessagesInLogDb(savedMessagesPath, std::string("uxas.messages.route.RoutePlanRequest")));
    EXPECT_EQ( 2, CountMessagesInLogDb(savedMessagesPath, std::string("uxas.messages.task.AssignmentCostMatrix")));
    EXPECT_EQ( 2, CountMessagesInLogDb(savedMessagesPath, std::string("uxas.messages.task.TaskAssignmentSummary")));
    EXPECT_EQ( 2, CountMessagesInLogDb(savedMessagesPath, std::string("uxas.messages.task.TaskImplementationRequest")));
    EXPECT_EQ( 2, CountMessagesInLogDb(savedMessagesPath, std::string("uxas.messages.task.TaskImplementationResponse")));
    EXPECT_EQ( 2, CountMessagesInLogDb(savedMessagesPath, std::string("uxas.messages.task.TaskInitialized")));
    EXPECT_EQ( 2, CountMessagesInLogDb(savedMessagesPath, std::string("uxas.messages.task.TaskPlanOptions")));
    EXPECT_EQ( 2, CountMessagesInLogDb(savedMessagesPath, std::string("uxas.messages.task.UniqueAutomationRequest")));
    EXPECT_EQ( 2, CountMessagesInLogDb(savedMessagesPath, std::string("uxas.messages.task.UniqueAutomationResponse")));
    EXPECT_EQ( 2, CountMessagesInLogDb(savedMessagesPath, std::string("uxas.messages.uxnative.CreateNewService")));
