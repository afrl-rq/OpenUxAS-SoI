...
TEST(LoiterTask_test, CorrectNumberMessages)
{
    //**************************************************************************
    ...
    testPath = "../tests/Test_Services/00_ExampleTests/99_Test_Tasks/Test_LoiterTask/";
    configFileName = "cfg_LoiterTask.xml";
    ...
    */
    ...
    EXPECT_EQ( 1, CountMessagesInLogDb(savedMessagesPath, std::string("afrl.cmasi.LoiterTask")));
