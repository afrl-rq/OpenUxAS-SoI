...
TEST(ImpactLineSearchTask_test, CorrectNumberMessages)
{
    //**************************************************************************
    ...
    testPath = "../tests/Test_Services/00_ExampleTests/99_Test_Tasks/Test_ImpactLineSearchTask/";
    configFileName = "cfg_ImpactLineSearchTask.xml";
