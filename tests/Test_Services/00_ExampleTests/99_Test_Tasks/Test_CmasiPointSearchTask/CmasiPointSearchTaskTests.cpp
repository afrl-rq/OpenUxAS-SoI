...
TEST(LineSearchTask_Test01, CorrectNumberMessages)
{
    //**************************************************************************
    ...
    testPath = "../tests/Test_Services/00_ExampleTests/99_Test_Tasks/Test_CmasiPointSearchTask/";
    configFileName = "cfg_CmasiPointSearchTask.xml";
