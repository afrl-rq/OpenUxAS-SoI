...
TEST(MultiVehicleWatchTask_test, CorrectNumberMessages)
{
    //**************************************************************************
    ...
    testPath = "../tests/Test_Services/00_ExampleTests/99_Test_Tasks/Test_MultiVehicleWatchTask/";
    configFileName = "cfg_MultiVehicleWatchTask.xml";
    ...
    */
    ...
    EXPECT_EQ( 1, CountMessagesInLogDb(savedMessagesPath, std::string("afrl.impact.MultiVehicleWatchTask")));
