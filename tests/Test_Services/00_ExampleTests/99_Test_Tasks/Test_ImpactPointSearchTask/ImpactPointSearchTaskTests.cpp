...
TEST(ImpactPointSearchTask_test, CorrectNumberMessages)
{
    //**************************************************************************
    ...
    testPath = "../tests/Test_Services/00_ExampleTests/99_Test_Tasks/Test_ImpactPointSearchTask/";
    configFileName = "cfg_ImpactPointSearchTask.xml";
    ...
    */
    ...
    EXPECT_EQ( 1, CountMessagesInLogDb(savedMessagesPath, std::string("afrl.impact.ImpactPointSearchTask")));
