...
TEST(HelloRust_Test01, CorrectNumberMessages)
{
    //**************************************************************************
    ...
    std::string testPath("../tests/Test_Services/00_ExampleTests/Test_HelloRust/");
    // uxasConfigurationFile - path and file name of the UxAS configuration file
    std::string uxasConfigurationFile = testPath + "cfg_HelloRust.xml";
