...
TEST(HelloWorld_Test01, CorrectNumberMessages)
{
    ...
    uint32_t duration_s{6}; // this test seems to take ~14.9s to send 10 messages on bash Ubuntu instances; it's about 8-10 msgs for duration 13, depending; this test is a bit odd because it keeps sending msgs until UxAS stops but test is for a certain number of sent messages only...
