...
/* 
 * File:   BackToBeginAttack.h
 * Author: steve
 *
 * Created on May 8, 2017, 5:55 PM
 */

#ifndef UXAS_BACK_TO_BEGIN_ATTACK_H
#define UXAS_BACK_TO_BEGIN_ATTACK_H
 ...
 *  <Service Type="BackToBeginAttack"/>
 * 
 * Subscribed Messages:
...
class BackToBeginAttack : public ServiceBase
{
public:

    /** \brief This string is used to identify this service in XML configuration
     * files, i.e. Service Type="BackToBeginAttack". It is also entered into
     * service registry and used to create new instances of this service. */
    static const std::string&
    s_typeName()
    {
        static std::string s_string("BackToBeginAttack");
        return (s_string);
    };
...
private:
    ...
    static
    ServiceBase::CreationRegistrar<BackToBeginAttack> s_registrar;

    /** brief Copy construction not permitted */
    BackToBeginAttack(BackToBeginAttack const&) = delete;

    /** brief Copy assignment operation not permitted */
    void operator=(BackToBeginAttack const&) = delete;
...
#endif /* UXAS_BACK_TO_BEGIN_ATTACK_H */
