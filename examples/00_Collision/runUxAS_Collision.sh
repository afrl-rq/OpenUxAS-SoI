...
cd $BIN2
java -Xmx2048m -splash:./data/amase_splash.png -classpath ./dist/*:./lib/*  avtas.app.Application --config config/daidalus --scenario "../../OpenUxAS/examples/00_Collision/MessagesToSend/collision_mkii.xml";
