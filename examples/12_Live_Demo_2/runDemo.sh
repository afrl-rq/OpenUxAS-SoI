...
cd $HOME/UxAS_pulls/OpenUxAS/examples/12_Live_Demo_2/



./runAMASE_Live_Demo_2.sh&

sleep 3

gnome-terminal --geometry=74x19+-10+14 --command "sh -c 'echo; cd ${HOME}/UxAS_pulls/OpenUxAS/examples/12_Live_Demo_2/; ./runUxAS_Live_Demo_2.sh; exec bash'"
